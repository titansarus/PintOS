...
از آنجایی که اصول یک طراحی مناسب در سیستم‌عامل سادگی، تمامیت، بهره‌وری و استفاده از منابع موجود در حد امکان می‌باشد، تنها با اضافه کردن چند فیلد جزئی در داده ساختار‌های 
pintos
