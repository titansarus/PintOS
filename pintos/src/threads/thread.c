...
bool
thread_priority_comparator (const struct list_elem *a, const struct list_elem *b, void *aux UNUSED) /*(0 w 0)*/
{
...
void
thread_set_priority_on_given (struct thread *cur, int new_priority, bool is_donation) /*(0 w 0)*/
{
